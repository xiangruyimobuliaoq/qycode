...
public interface IRegister {
     ...
     * @param action            {@link com.penglong.android.libsocket.sdk.connection.interfacies.IAction}
     */
     ...
     * 注册一个回调接收器
     *
     * @param socketResponseHandler 回调接收器 {@link com.penglong.android.libsocket.sdk.SocketActionAdapter}
     */
